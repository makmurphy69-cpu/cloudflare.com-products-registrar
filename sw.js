...
const CDN_LIMIT = 80;
const CORE = ['/', '/index.html', '/local-tools.css', '/tutorials.css', '/tutorials.js', '/miga-extras.js', '/miga-sandbox.js', '/usage-counter.js', '/i18n.js', '/favicon.svg', '/manifest.webmanifest', '/404.html'];
