...
(function(){
  ...
  const tools={
    ...
    'body-map.html':['Body Map','click any organ on the body to read how it works, its connections, illnesses and care','Generate quiz','follow a meal in Eating and drinking, try the Fasting slider, then play or make your own quiz'],
